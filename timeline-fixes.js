// Timeline 閱讀性與行程資料修正：統一「地名｜補充說明」格式、拉開行程間距、統一固定行程視覺。
(() => {
  ...
  style.textContent = `
    ...
    /* 主要資訊同一行：時間 → 地名 → ｜ → 補充說明。 */
    .tl-primary{display:flex!important;align-items:baseline!important;gap:8px!important;flex-wrap:wrap!important}
    .tl-title{font-weight:900!important}
    .tl-inline-detail{color:#66717d!important;font-weight:600!important}
    .tl-sep{color:#a5adb6!important;font-weight:500!important}
